...
export default function App() {
  ...
  const handleSelectYearMonth = useCallback((targetYear: number, targetMonth: number) => {
  ...
  return (
    <div className="bg-gray-950 text-gray-100 min-h-screen flex flex-col antialiased">
      ...
      <Navbar
        ...
        onOpenGroupRules={currentUser?.role !== 'merchant' ? () => setShowGroupRulesModal(true) : undefined}
